...
<body>
    <div class="error-box">
        ...
        <p class="error-msg">You do not have permission to view this page.</p>
        <a href="<?= BASE_URL ?>/index.php?page=dashboard" class="btn btn-warning btn-lg">
